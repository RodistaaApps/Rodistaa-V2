...
export function OverviewTab({ operator, theme = "dark" }: OverviewTabProps) {
  ...
  return (
    <div style={{ padding: "24px 0" }}>
          ...
          <Col xs={24} md={16}>
            <Row gutter={[16, 16]}>
              ...
              <Col span={12}>
                ...
                <div>
                  <Tag color="blue">{operator.franchise}</Tag>
                </div>
              </Col>
            </Row>
          </Col>
        ...
        <Col xs={12} sm={12} md={6}>
          <Card style={{ background: bgCard, border: `1px solid ${border}` }}>
            <Statistic
              ...
              value={operator.ledger_balance}
              prefix="₹"
              valueStyle={{
                color: operator.ledger_balance < 0 ? "#EF4444" : "#10B981",
                fontWeight: "bold",
              }}
              precision={2}
            />
      ...
      <Card
        title={<span style={{ color: textPrimary }}>Quick Actions</span>}
