...
export function AdminLayout({ children, theme: propTheme, toggleTheme: propToggleTheme }: AdminLayoutProps) {
  ...
  const menuItems = [
    ...
    { key: '/admin/controls', icon: <SettingOutlined />, label: 'Admin Controls' },
      ...
      <Layout>
        <Header style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
            <Button
              type="text"
              icon={<MenuOutlined style={{ color: isDark ? '#FFFFFF' : '#0A0E14' }} />}
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
            <div style={{
              ...
              <SunOutlined style={{ color: !isDark ? '#C90D0D' : '#6B7280', fontSize: '16px' }} />
              <Switch
                checked={isDark}
              ...
              />
              <MoonOutlined style={{ color: isDark ? '#C90D0D' : '#6B7280', fontSize: '16px' }} />
            </div>

            <Button
              type="text"
              icon={<BellOutlined style={{ color: isDark ? '#FFFFFF' : '#0A0E14', fontSize: '20px' }} />}
            />
