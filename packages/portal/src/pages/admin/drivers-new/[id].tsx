  ...
  const fetchDriverDetails = async () => {
    ...
    try {
      ...
      const mockDriver: DriverDetail = {
        ...
        aadhar_name: "Ramesh Kumar Singh",
        aadhar_number: "5678-1234-9012",
        address: {
          line1: "House 23, Gandhi Nagar",
        ...
        assigned_operator: "Rajesh Transport Co.",
        ...
        last_known_location: {
          lat: 16.5062,
          lng: 80.648,
          address: "Near Guntur Toll Plaza, NH-16",
        },
        kyc_status: "verified",
        behaviour_score: 88,
        ledger_balance: 5600.0,
