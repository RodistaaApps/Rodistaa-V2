  ...
  const columns = [
    {
      ...
      render: (t: string) => (
        <span style={{ fontWeight: 600, color: textPrimary }}>{t}</span>
      ),
    },
    {
      title: "Type",
      ...
      key: "vehicleType",
      render: (t: string) => <span style={{ color: textPrimary }}>{t}</span>,
    },
    {
      title: "Operator",
    ...
    },
    {
      ...
      render: (d: number) =>
        d > 0 ? (
          <span style={{ color: "#C90D0D" }}>
            <WarningOutlined /> {d} expiring
          </span>
        ) : (
          <span style={{ color: textPrimary }}>OK</span>
        ),
    },
    {
      title: "Trips",
      ...
      key: "totalTrips",
      render: (t: number) => <span style={{ color: textPrimary }}>{t}</span>,
    },
    {
      title: "Actions",
      key: "actions",
          ...
          >
            {selectedTruck && (
              <div style={{ color: textPrimary }}>
                Details for {selectedTruck.registrationNumber}
              </div>
            )}
          </Modal>
        </div>
