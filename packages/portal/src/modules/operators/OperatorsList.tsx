    ...
    },
    {
      ...
      render: (_: any, record: Operator) => (
        <div style={{ fontSize: "13px" }}>
          <Tooltip
            title={`Total: ${record.trucks.total}, Active: ${record.trucks.active}, Blocked: ${record.trucks.blocked}`}
          >
            <span style={{ color: textSecondary }}>
              <span style={{ color: textPrimary, fontWeight: 600 }}>
                T:{record.trucks.total}
              </span>
              {" • "}
              <span style={{ color: "#10B981" }}>A:{record.trucks.active}</span>
              {" • "}
              <span style={{ color: "#EF4444" }}>
                B:{record.trucks.blocked}
              </span>
            </span>
          </Tooltip>
        </div>
