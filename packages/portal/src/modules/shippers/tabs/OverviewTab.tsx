  ...
  return (
    <div style={{ padding: '24px 0' }}>
      ...
      <Card style={{ marginBottom: '24px', background: bgCard, border: `1px solid ${border}` }}>
        <Row gutter={[24, 24]} align="middle">
            ...
            <div style={{ textAlign: 'center' }}>
              <div style={{ marginBottom: '16px' }}>
                <Progress
                  ...
                  format={(percent) => (
                    <div>
                      <div style={{ fontSize: '32px', fontWeight: 'bold', color: textPrimary }}>
                        {percent}
                      </div>
              ...
              <div style={{ color: textSecondary, fontSize: '13px' }}>
                ...
                {shipper.trust_score >= 75 && shipper.trust_score < 90 && '✅ Good'}
                {shipper.trust_score >= 60 && shipper.trust_score < 75 && '⚠️ Fair'}
          ...
          <Col xs={24} md={16}>
            <Row gutter={[16, 16]}>
              <Col span={12}>
                <div style={{ marginBottom: '8px', color: textSecondary, fontSize: '12px' }}>
                  Email
                </div>
            ...
            <Space>
              ...
              <div>
                <div style={{ color: textPrimary, fontWeight: 600, marginBottom: '4px' }}>
                  {shipper.acs_flags.length} Active ACS Flag{shipper.acs_flags.length > 1 ? 's' : ''}
                </div>
                <div style={{ color: textSecondary, fontSize: '13px' }}>
                  {shipper.acs_flags[0]?.summary}
                  {shipper.acs_flags.length > 1 && ` and ${shipper.acs_flags.length - 1} more...`}
                </div>
              </div>
            </Space>
          </div>
      ...
      <Row gutter={[16, 16]} style={{ marginBottom: '24px' }}>
        <Col xs={12} sm={12} md={6}>
          <Card style={{ background: bgCard, border: `1px solid ${border}` }}>
            <Statistic
              title={<span style={{ color: textSecondary }}>Active Bookings</span>}
      ...
      <Card
        ...
        style={{ marginBottom: '24px', background: bgCard, border: `1px solid ${border}` }}
      >
        <Row gutter={[16, 16]}>
          <Col span={12}>
            <div style={{ marginBottom: '8px', color: textSecondary, fontSize: '12px' }}>
            ...
            <div style={{ color: textPrimary, fontWeight: 500 }}>
              ...
              <Tooltip title={dayjs(shipper.last_active).format('DD MMM YYYY, HH:mm')}>
          ...
          <Col span={12}>
            ...
            <div style={{ color: textPrimary, fontWeight: 600, fontSize: '18px' }}>
      ...
      >
        <Row gutter={[16, 24]}>
          ...
          <Col span={24}>
            <div style={{ marginBottom: '8px', display: 'flex', justifyContent: 'space-between' }}>
              <span style={{ color: textSecondary }}>Booking Completion Rate</span>
