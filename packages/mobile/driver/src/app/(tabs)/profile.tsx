    ...
    <ScrollView style={styles.container}>
      ...
      <Card style={styles.section}>
        ...
        <View style={styles.infoRow}>
          ...
          <Text style={styles.infoValue}>Valid</Text>
        </View>
      </Card>

      <Card style={styles.section}>
        <Text style={styles.sectionTitle}>GPS & Tracking</Text>
        <Text style={styles.settingItem}>• GPS Streaming: Active during shipments</Text>
        <Text style={styles.settingItem}>• Ping Interval: 60 seconds</Text>
        <Text style={styles.settingItem}>• Background Fetch: Enabled</Text>
      </Card>
