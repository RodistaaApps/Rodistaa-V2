  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.section}>
        ...
        >
          <View style={styles.menuIconContainer}>
            <Ionicons name="car-outline" size={24} color="#C90D0D" />
          </View>
          <Text style={styles.menuText}>My Trucks</Text>
          <Ionicons name="chevron-forward" size={24} color="#D0D0D0" />
        </TouchableOpacity>
        ...
        >
          <View style={styles.menuIconContainer}>
            <Ionicons name="people-outline" size={24} color="#C90D0D" />
          </View>
          <Text style={styles.menuText}>Drivers</Text>
          <Ionicons name="chevron-forward" size={24} color="#D0D0D0" />
        </TouchableOpacity>
        ...
        >
          <View style={styles.menuIconContainer}>
            <Ionicons name="camera-outline" size={24} color="#C90D0D" />
          </View>
          <Text style={styles.menuText}>Inspection History</Text>
          <Ionicons name="chevron-forward" size={24} color="#D0D0D0" />
        </TouchableOpacity>
      </View>
      ...
      <View style={styles.section}>
        ...
        >
          <View style={styles.menuIconContainer}>
            <Ionicons name="document-outline" size={24} color="#C90D0D" />
          </View>
